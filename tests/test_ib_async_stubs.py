...
def verify_setup():
    ...
    typings_dir = "/home/jrae/wsl projects/Trading/typings/ib_async"
    stub_file = "/home/jrae/wsl projects/Trading/typings/ib_async/__init__.pyi"
    config_file = "/home/jrae/wsl projects/Trading/pyrightconfig.json"
    
    checks: list[str] = []
    
    # Check typings directory
    if os.path.exists(typings_dir):
